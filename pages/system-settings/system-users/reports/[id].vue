<template>
    ...
    <v-dialog v-model="dialog" persistent hide-overlay width="800" scrollable>
        <v-card>
            <v-card-title>System User Reports</v-card-title>
            <v-card-text>
                <v-container>
                    <v-row>
