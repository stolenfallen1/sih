<template>
    <v-dialog :model-value="open_patient_pharma_request" rounded="lg" @update:model-value="closeDialog" scrollable max-width="1120px">
        <v-card rounded="lg">
            <v-toolbar density="compact" color="#107bac" hide-details>
                <v-toolbar-title>Check the Status of Pharma Requests</v-toolbar-title>
