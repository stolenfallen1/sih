<template>
    <v-row>
        <v-col cols="4">
            ...
            <v-col cols="12" class="form-col">
                <v-checkbox v-model="payload.isWithMedicalPackage" label="With Hospital Package?" hide-details density="compact"></v-checkbox>
                <v-btn :disabled="!payload.isWithMedicalPackage" @click="handleMedicalPackage">Apply Medical Package</v-btn>
            </v-col>
        </v-col>
        <v-col cols="8">
            <v-col cols="12" class="form-col">
            ...
            <v-col v-if="form_type === 'emergency'" cols="5" class="form-col">
                <v-checkbox label="Dead on Arrival?" v-model="payload.dead_on_arrival" hide-details density="compact"></v-checkbox>
            </v-col>
