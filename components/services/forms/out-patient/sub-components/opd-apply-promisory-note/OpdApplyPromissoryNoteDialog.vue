<template>
    ...
    <OpdTransferTagging :open_tag_transactions="open_tag_transactions" @close-dialog="closeTagTransactions" />
    <OpdObligatorDetails :open_obligator_details="open_obligator_details" @close-dialog="closeObligatorDetails" />
</template>

<script setup>
import OpdObligatorDetails from "./sub-forms/OpdObligatorDetails.vue";
import OpdTransferTagging from "../opd-post-ar-transfer/sub-forms/OpdTransferTagging.vue";
