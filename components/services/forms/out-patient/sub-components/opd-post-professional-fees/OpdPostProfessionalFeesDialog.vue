<template>
    ...
    <opd-select-doctor :open_select_doctor="open_select_doctor" @close-dialog="closeSelectDoctor" @handle-submit="handleSelectDoctor" />
</template>

<script setup>
import OpdSelectDoctor from './sub-forms/OpdSelectDoctor.vue';
