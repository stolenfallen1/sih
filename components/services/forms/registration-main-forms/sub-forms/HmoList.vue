<template>
    <v-dialog :model-value="open_hmo_list" rounded="lg" @update:model-value="closeDialog" scrollable max-width="700px">
        <form @submit.prevent="onSubmit">
            <v-card rounded="lg">
                <v-toolbar density="compact" color="#6984ff" hide-details>
                    <v-toolbar-title>HMO Guarantor List</v-toolbar-title>
                ...
                <v-card-actions>
                    ...
                    <v-spacer></v-spacer>
                    <v-btn class="bg-primary text-white" type="submit">Submit Selected Guarantor</v-btn>
                </v-card-actions>
            </v-card>
        </form>
    </v-dialog>
...
const onSubmit = () => {
    ...
    //     return alert('Please select a guarantor.');
    // }
    emits('handle-select');
}
