<template>
    ...
    <AddDischargeMedicine :open_add_medicines="open_add_medicines" @close-dialog="closeAddMedicines" @handle-submit="handleSelectMedicine" />
</template>

<script setup>
import AddDischargeMedicine from "./sub-forms/AddDischargeMedicine.vue";
