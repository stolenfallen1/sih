<template>
            ...
            <v-row class="py-1 px-1">
                <v-col cols="6">
                    <fieldset class="pa-3 rounded-fieldset">
                        ...
                        <v-row>
                            <v-col cols="4">
                                <v-list-subheader class="form-header">Scheme <span style="color: red;" class="mdi mdi-check"></span></v-list-subheader>
                            </v-col>
                            <v-col>
                                <v-autocomplete
                ...
                <v-col cols="6">
                    <fieldset class="pa-3 rounded-fieldset">
                        ...
                        <v-row>
                            <v-col cols="4">
                                <v-list-subheader class="form-header">Case Type</v-list-subheader>
                            </v-col>
                            <v-col>
                                <v-autocomplete
                                    variant="outlined"
                        ...
                        <v-row>
                            <v-col cols="4">
                                <v-list-subheader class="form-header">Case Date<span style="color: red;" class="mdi mdi-check"></span></v-list-subheader>
                            </v-col>
                            <v-col>
                                <v-text-field
                                    ref="registry_date"
            ...
            <v-row class="py-1 px-1">
                <v-col cols="6" class="py-1">
                    <v-col cols="12" class="form-col">
                        <v-checkbox 
                            label="Ckeck if patient is dead on arrival?" 
                    ...
                    <v-col v-if="payload.dead_on_arrival" cols="12">
                        <fieldset class="pa-3 rounded-fieldset">
                            ...
                            <v-row>
                                ...
                                <v-col>
                                    <v-text-field
                                        ...
                                        :disabled="!payload"
                                        :readonly="clicked_option === 'view'"
                                        :error-messages="formErrors.dateOfDeath ? [formErrors.dateOfDeath] : []"
                                        type="date"
                                        hide-details
                                        density="compact"
                                    ></v-text-field>
    ...
    <v-card>
        <v-card-text>
            ...
            <div v-if="enabled || parseInt(payload.mscDisposition_Id) === 3">
                <v-divider class="py-2"></v-divider>
                <v-row class="py-2">
                    <v-col cols="6">
                        <fieldset class="pa-3 rounded-fieldset">
                            <legend class="pa-2">Refered From HCI</legend>
                            <v-row>
                                <v-col cols="4">
                    ...
                    <v-col cols="6">
                        <fieldset class="pa-3 rounded-fieldset">
                            <legend class="pa-2">To HCI</legend>
                            <v-row>
                                <v-col cols="4">
                                    <v-list-subheader :class="{'text-muted': !enabled && parseInt(payload.mscDisposition_Id) !== 3, 'form-header': true}">Name</v-list-subheader>
                                </v-col>
                ...
                <v-row class="py-8">
                    ...
                    <v-col cols="6">
                        <v-row>
                            <v-col cols="4">
                                <v-list-subheader :class="{'text-muted': !enabled && parseInt(payload.mscDisposition_Id) !== 3, 'form-header': true}">Reason</v-list-subheader>
                            </v-col>
                            <v-col>
                                <v-textarea
...
<script setup>
    ...
    const getTransactionType = async () => {
        ...
        if (response) {
            ...
            patientDataStore.setPatientTransactionType(response);
    ...
    const runCheckerFunction = () =>  {
        ...
        try {
            if(
                ...
                !patientDataStore.storePatientNationality &&
                ...
                patientBroughtBy.value          = patientDataStore.storePatientBroughtBy
                nationality_data.value          = patientDataStore.storePatientNationality 
                ...
                register_case_type_data.value   = patientDataStore.storePatientCaseType

                props.payload.register_Source   = register_source_data.value[0].id
                if (!props.payload.mscAccount_Type && hospitalization_plan_data.value.length > 0) {
                    props.payload.mscAccount_Type = hospitalization_plan_data.value[0].id;
                }
                props.payload.mscAccount_Trans_Types = transaction_type_data.value[4].id;
                props.payload.register_Casetype = register_case_type_data.value[0].id;
                props.payload.mscBroughtBy_Relationship_Id = patientBroughtBy.value[0].id;
            }
        } catch(error) {
    ...
    const loadData = async () => {
        try {
            ...
            if(
                ...
                patientDataStore.setPatientBroughtBy(patientBroughtBy.value);
                patientDataStore.setPatientNationalityId(nationality_data.value);
                ...
                patientDataStore.setPatientCaseType(register_case_type_data.value);
            }
        } catch(error) {
