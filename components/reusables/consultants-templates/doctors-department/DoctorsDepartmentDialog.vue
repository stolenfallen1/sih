<template>
  <v-dialog :model-value="show" rounded="lg" persistent scrollable max-width="700px">
      ...
      <v-card rounded="lg">
          <v-toolbar density="compact" color="#6984ff" hide-details>
              <v-toolbar-title>Doctors Department</v-toolbar-title>
              <v-spacer></v-spacer>
  ...
  <doctors-department-form :open_form_dialog="open_form_dialog" @close-dialog="closeFormDialog" @handle-submit="onSubmit" />
  <deleteConfirmation :show="confirmation" @confirm="confirm" @close="closeconfirmation" />
</template>

<script setup>
import DoctorsDepartmentForm from './sub-forms/DoctorsDepartmentForm.vue';
