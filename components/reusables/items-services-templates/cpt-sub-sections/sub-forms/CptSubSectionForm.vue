<template>
    <v-dialog :model-value="open_cpt_sub_section_form" rounded="lg" persistent scrollable max-width="700px">
        <v-toolbar color="#6984ff" hide-details density="compact">
            <v-toolbar-title>CPT Sub Section Details</v-toolbar-title>
        </v-toolbar>
        <v-card>
            <v-card-text>
                <v-container>
