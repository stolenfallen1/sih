  ...
  <v-dialog :model-value="show" rounded="lg" @update:model-value="closeDialog"  scrollable max-width="700px">
      <v-card rounded="lg">
          <v-toolbar density="compact" color="#107bac" hide-details>
              <v-toolbar-title>Price Groups</v-toolbar-title>
              <v-spacer></v-spacer>
          ...
          <v-card-actions>
              ...
              <v-spacer></v-spacer>
              <v-btn class="bg-primary text-white" type="submit" @click="openItemPriceGroupForm">Add</v-btn>
          </v-card-actions>
      </v-card>
  </v-dialog>
  <price-group-form :open_form_dialog="open_form_dialog" :payload="payload" @close-dialog="closeItemPriceGroupForm" @handle-submit="onSubmit" />
  <deleteConfirmation :show="confirmation" @confirm="confirm" @close="closeconfirmation" />
</template>

<script setup>
import PriceGroupForm from "./sub-forms/PriceGroupForm.vue"
