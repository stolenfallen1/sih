<template>
    <v-dialog :model-value="show" rounded="lg" persistent scrollable max-width="700px">
        <v-toolbar density="compact" color="#6984ff" hide-details>
            <v-toolbar-title>Collection Report Main Header</v-toolbar-title>
            <v-spacer></v-spacer>
        ...
        <v-card>
            ...
            <v-card-actions>
                ...
                <v-spacer></v-spacer>
                <v-btn class="bg-primary text-white" type="submit" @click="openCollectionReportMain">Add</v-btn>
            </v-card-actions>
        </v-card>
    </v-dialog>
    <collection-report-main-form :open_collection_report_form="open_collection_report_form" @close-dialog="closeCollectionReportMain" @handle-submit="onSubmit" />
</template>

<script setup>
import CollectionReportMainForm from './sub-forms/CollectionReportMainForm.vue';
...
const openCollectionReportMain = () => {
