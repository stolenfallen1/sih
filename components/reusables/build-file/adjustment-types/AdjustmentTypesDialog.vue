<template>
  <v-dialog :model-value="show" rounded="lg" @update:model-value="closeDialog" scrollable max-width="700px">
      <v-card rounded="lg">
          <v-toolbar density="compact" color="#107bac" hide-details>
              <v-toolbar-title>Adjustment Categories</v-toolbar-title>
              <v-spacer></v-spacer>
  ...
  <adjustment-types-form :open_form_dialog="open_form_dialog" @close-dialog="closeFormDialog" @handle-submit="onSubmit" />
...
const headers = [
  ...
  { title: 'Account Code', key: 'account_code', align: 'start' },
  { title: 'Journal Column Placement', key: 'journal_column', align: 'start', width: "10%" },
