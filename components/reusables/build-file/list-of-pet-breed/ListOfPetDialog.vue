<template>
  <v-dialog :model-value="show" rounded="lg" @update:model-value="closeDialog"  scrollable max-width="700px">
      <v-card rounded="lg">
          <v-toolbar density="compact" color="#6984ff" hide-details>
              <v-toolbar-title>List of Pet Breed</v-toolbar-title>
              <v-spacer></v-spacer>
  ...
  <list-of-pet-form :open_form_dialog="open_form_dialog" @close-dialog="closeFormDialog" @handle-submit="onSubmit" />
  <deleteConfirmation :show="confirmation" @confirm="confirm" @close="closeconfirmation" />
</template>

<script setup>
import ListOfPetForm from './sub-forms/ListOfPetForm.vue';
...
const headers = [
  ...
  { title: 'Species', key: 'species', align: 'start' },
  { title: 'Pet Breed', key: 'pet_breed', align: 'start', width:"45%" },
