<template>
  ...
  <cs-case-indicators-form :open_form_dialog="open_form_dialog" @close-dialog="closeFormDialog" @handle-submit="onSubmit" />
  <deleteConfirmation :show="confirmation" @confirm="confirm" @close="closeconfirmation" />
</template>

<script setup>
import CsCaseIndicatorsForm from './sub-forms/CsCaseIndicatorsForm.vue';
