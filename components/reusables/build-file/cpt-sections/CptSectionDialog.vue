    ...
    <v-dialog :model-value="show" rounded="lg" @update:model-value="closeDialog" scrollable max-width="700px">
        <v-card rounded="lg">
            <v-toolbar density="compact" color="#6984ff" hide-details>
                <v-toolbar-title>CPT Sections</v-toolbar-title>
                <v-spacer></v-spacer>
            ...
            <v-card-actions>
                ...
                <v-spacer></v-spacer>
                <v-btn class="bg-primary text-white" type="submit" @click="openCptSectionForm">Add</v-btn>
            </v-card-actions>
        </v-card>
    </v-dialog>
    <cpt-section-form :open_cpt_section_form="open_cpt_section_form" @close-dialog="closeCptSectionForm" @handle-submit="onSubmit" />
</template>

<script setup>
import CptSectionForm from './sub-forms/CptSectionForm.vue';
...
const open_cpt_section_form = ref(false)
...
const openCptSectionForm = () => {
    open_cpt_section_form.value = true;
}

const closeCptSectionForm = () => {
    open_cpt_section_form.value = false;
}
