<template>
  <v-dialog :model-value="show" rounded="lg" @update:model-value="closeDialog"  scrollable max-width="700px">
      <v-card rounded="lg">
          <v-toolbar density="compact" color="#6984ff" hide-details>
              <v-toolbar-title>Referring Centers</v-toolbar-title>
              <v-spacer></v-spacer>
  ...
  <referring-centers-form :open_form_dialog="open_form_dialog" @close-dialog="closeFormDialog" @handle-submit="onSubmit" />
  <deleteConfirmation :show="confirmation" @confirm="confirm" @close="closeconfirmation" />
</template>

<script setup>
import ReferringCentersForm from './sub-forms/ReferringCentersForm.vue';
...
const headers = [
  ...
  { title: 'Referred IHCP Code', key: 'referred_ihcp_code', align: 'start' },
