<template>
  <v-dialog :model-value="open_diet_class_dialog" rounded="lg" @update:model-value="closeDialog"  scrollable max-width="825px">
    <form @submit.prevent="handleSubmit">
      <v-card rounded="lg">
          <v-toolbar density="compact" color="#6984ff" hide-details>
              <v-toolbar-title>Select Diet Class</v-toolbar-title>
