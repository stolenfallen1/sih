<template>
  <v-dialog :model-value="show" rounded="lg" @update:model-value="closeDialog"  scrollable max-width="700px">
      <v-card rounded="lg">
          <v-toolbar density="compact" color="#6984ff" hide-details>
              <v-toolbar-title>Other Specialist</v-toolbar-title>
              <v-spacer></v-spacer>
  ...
  <other-specialist-form :open_form_dialog="open_form_dialog" @close-dialog="closeFormDialog" @handle-submit="onSubmit" />
  <deleteConfirmation :show="confirmation" @confirm="confirm" @close="closeconfirmation" />
</template>

<script setup>
import OtherSpecialistForm from "./sub-forms/OtherSpecialistForm.vue";
...
const headers = [
  ...
  { title: 'Specialization', key: 'description', align: 'start', width:"60%" },
];
const data = ref({
  title: "List of Unit",
  keyword: "",
