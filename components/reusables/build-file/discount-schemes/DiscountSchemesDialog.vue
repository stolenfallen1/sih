<template>
  ...
  <discount-scheme-form :open_form_dialog="open_form_dialog" @close-dialog="closeFormDialog" @handle-submit="onSubmit" />
  <deleteConfirmation :show="confirmation" @confirm="confirm" @close="closeconfirmation" />
</template>

<script setup>
import DiscountSchemeForm from './sub-forms/DiscountSchemeForm.vue';
