...
const headers = [
    { title: "Calculated Hour(s) Range From", key: "calculate_hour_range_from", align: "start", width: "15%" },
    { title: "Calculated Hour(s) Range To", key: "calculate_hour_range_to", align: "start", width: "15%" },
    { title: "Hour(s) to Charge", key: "hour_to_charge", align: "start", width: "15%" },
    { title: "Day(s) to Charge", key: "day_to_charge", align: "start", width: "15%" },
    { title: "Notes. Remarks", key: "notes_remarks", align: "start", width: "15%" },
    { title: "", key: "actions", align: "start", width: "15%" },
];
const data = ref({
    title: "List of Room Charge Settings",
    keyword: "",
    loading: false,
    filter: {},
    tab: 0,
