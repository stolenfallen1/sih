             ...
             <v-col cols="9">
               ...
               <v-col cols="6">
                <v-text-field
                  ...
                  required
                  v-model="payload.headquarters_location"
                  clearable
                  hide-details
                ></v-text-field>
              </v-col>
...
const onSubmit = async () => {
  ...
  if (payload.value.id) {
    response = await useMethod("put", "banks", payload.value, "", payload.value.id);
  } else {
    response = await useMethod("post", "banks", payload.value);
  }
  if (response) {
