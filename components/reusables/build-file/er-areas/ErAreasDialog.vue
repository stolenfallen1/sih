<template>
    <v-dialog :model-value="show" rounded="lg" @update:model-value="closeDialog"  scrollable max-width="900px">
        <v-card rounded="lg">
            <v-toolbar density="compact" color="#107bac" hide-details>
                <v-toolbar-title>E.R. Area Template</v-toolbar-title>
                <v-spacer></v-spacer>
    ...
    >
      <form @submit.prevent="onSubmit">
        <v-card rounded="lg">
          <v-toolbar density="compact" color="#107bac" hide-details>
            <v-toolbar-title>E.R. Area Details</v-toolbar-title>
          ...
          <v-card-text>
            <v-row>
              ...
              <v-col cols="12">
                <v-card elevation="4">
                  <v-card-text>
                    <v-table hide-details density="compact" height="45vh">
                        <thead>
                            <tr>
                                <th>Description</th>
                                <th>Bed Status</th>
                        ...
                        <tbody>
                            <!-- <tr v-for="" :key="" class="cursor-pointer">
                            </tr> -->
                        </tbody>
                    </v-table>
                  </v-card-text>
          ...
          <v-divider></v-divider>
          <v-card-actions>
            <v-btn color="blue-darken-1 border border-info" @click="closeFormDialog"> Close </v-btn>
            <v-spacer></v-spacer>
  ...
  const headers = [
    ...
    { title: 'No. of Beds', key: 'no_of_beds', align: 'start' },
