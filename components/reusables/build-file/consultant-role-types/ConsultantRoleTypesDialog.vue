  ...
  <v-dialog :model-value="show" rounded="lg" @update:model-value="closeDialog" scrollable max-width="700px">
      <v-card rounded="lg">
          <v-toolbar density="compact" color="#6984ff" hide-details>
              <v-toolbar-title>Consultant Role Types</v-toolbar-title>
              <v-spacer></v-spacer>
...
<script setup>
import ConsultantRoleTypeForm from './sub-forms/ConsultantRoleTypeForm.vue';
...
const headers = [
  ...
  { title: 'PHIC Type', key: 'phic_type', align: 'start' },
