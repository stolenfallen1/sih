<template>
    ...
    <item-pricing-scheme-form :msc_price_group="msc_price_group" :payload="payload" :open_item_pricing_schemes_form="open_item_pricing_schemes_form" @close-dialog="closeItemPricingSchemeForm" @handle-submit="onSubmit" />
