<template>
    ...
    <department-group-form :payload="payload" :department_groups_form="department_groups_form" @close-dialog="closeDepartmentGroupsForm" @handle-submit="onSubmit" />
