  ...
  <v-dialog :model-value="show" rounded="lg" @update:model-value="closeDialog"  scrollable max-width="750px">
    <v-card rounded="lg">
      <v-toolbar density="compact" color="#6984ff" hide-details>
        <v-toolbar-title>Diet Classification</v-toolbar-title>
        <v-spacer></v-spacer>
...
@update:model-value="closeForm"
  ...
  >
    <form @submit.prevent="onSubmit">
      <v-card rounded="lg">
        <v-toolbar density="compact" color="#6984ff" hide-details>
          <v-toolbar-title>Diet Classification Details</v-toolbar-title>
...
const headers = [
  ...
  { title: "Description", key: "id_description", align: "start", width: "50%" },
