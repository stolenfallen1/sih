    ...
    <v-dialog :model-value="show" rounded="lg" @update:model-value="closeDialog"  scrollable max-width="700px">
        <v-card rounded="lg">
            <v-toolbar density="compact" color="#6984ff" hide-details>
                <v-toolbar-title>Indications</v-toolbar-title>
                <v-spacer></v-spacer>
            ...
            <v-card-actions>
                ...
                <v-spacer></v-spacer>
                <v-btn class="bg-primary text-white" type="submit" @click="openIndicationsForm">Add</v-btn>
            </v-card-actions>
        </v-card>
    </v-dialog>
    <indications-form :open_indications_form="open_indications_form" @close-dialog="closeIndicationsForm" @handle-submit="onSubmit" />
</template>

<script setup>
import IndicationsForm from './sub-forms/IndicationsForm.vue';
...
const open_indications_form = ref(false)
...
const openIndicationsForm = () => {
    open_indications_form.value = true;
}

const closeIndicationsForm = () => {
    open_indications_form.value = false;
}
