<template>
  <v-dialog :model-value="show" rounded="lg" @update:model-value="closeDialog"  scrollable max-width="700px">
      <v-card rounded="lg">
          <v-toolbar density="compact" color="#6984ff" hide-details>
              <v-toolbar-title>Educational Attainments</v-toolbar-title>
              <v-spacer></v-spacer>
  ...
  <educational-attainment-form :open_form_dialog="open_form_dialog" @close-dialog="closeFormDialog" @handle-submit="onSubmit" />
  <deleteConfirmation :show="confirmation" @confirm="confirm" @close="closeconfirmation" />
</template>

<script setup>
import EducationalAttainmentForm from './sub-forms/EducationalAttainmentForm.vue';
...
const headers = [
  {
      title: 'Educational Attainment ID',
      align: 'start',
      sortable: false,
      key: 'id',
  },
  { title: 'Pet Breed', key: 'pet_breed', align: 'start', width:"50%" },
