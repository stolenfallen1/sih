<template>
  ...
  <room-status-form :open_form_dialog="open_form_dialog" @close-dialog="closeFormDialog" @handle-submit="onSubmit"  />
  <deleteConfirmation :show="confirmation" @confirm="confirm" @close="closeconfirmation" />
</template>

<script setup>
import RoomStatusForm from './sub-forms/RoomStatusForm.vue';
...
const room_status = [
  { code: 1, description: 24, system_default: "Yes", actions: true },
  { code: 2, description: 18, system_default: "Yes", actions: true },
]
