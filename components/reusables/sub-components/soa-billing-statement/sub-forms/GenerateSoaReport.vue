<template>
    ...
    <manage-soa-settings :settings="settings" :open_manage_soa_settings="open_manage_soa_settings" @close-dialog="closeManageSoaSettings" @handle-submit="handleManageSoaSettings" />
</template>

<script setup>
import ManageSoaSettings from './ManageSoaSettings.vue';
