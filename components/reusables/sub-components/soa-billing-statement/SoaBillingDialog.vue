<template>
    ...
    <generate-soa-report :open_generate_report="open_generate_report" @close-dialog="closeGenerateReport" @handle-submit="handleGenerateReport" />
</template>

<script setup>
import GenerateSoaReport from './sub-forms/GenerateSoaReport.vue';
