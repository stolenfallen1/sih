<template>
    <v-dialog :model-value="open_surgeon_master" rounded="lg" @update:model-value="closeDialog"  scrollable max-width="800px">
        <form @submit.prevent="onSubmit">        
            <v-card rounded="lg">
                <v-toolbar density="compact" color="#107bac" hide-details>
                    <v-toolbar-title>Select Surgeon</v-toolbar-title>
                    <v-spacer></v-spacer>
...
const service_types = []
const headers = [
    { title: 'Surgeon Name', key: 'surgeon_name', align: 'start',width:"70%" },
    { title: 'Case Type', key: 'case_type', align: 'start' },
];
const data = ref({
    title: "List of Surgeon",
    keyword: "",
    loading: false,
    filter: {},
    tab: 0,
