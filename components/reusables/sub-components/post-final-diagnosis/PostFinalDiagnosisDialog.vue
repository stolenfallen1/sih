<template>
        ...
        <form @submit.prevent="onSubmit">
            <v-card rounded="lg">
                <v-toolbar density="compact" color="#6984ff" hide-details>
                    <v-toolbar-title>Post Final Diagnosis {{ selectedRowDetails.id }}</v-toolbar-title>
    ...
    <icd-master :open_icd_master="open_icd_master" @close-dialog="closeSelectIDCMaster" @handle-submit="handleSelectICDMaster" />
    <surgeon-master :open_surgeon_master="open_surgeon_master" @close-dialog="closeSelectSurgeonMaster" @handle-submit="handleSelectSurgeonMaster" />
</template>

<script setup>
import IcdMaster from './sub-forms/IcdMaster.vue';
import SurgeonMaster from './sub-forms/SurgeonMaster.vue';
