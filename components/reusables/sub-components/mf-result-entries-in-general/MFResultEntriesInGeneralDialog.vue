<template>
    <v-dialog :model-value="show" rounded="lg" scrollable @update:model-value="closeDialog" max-width="800px">
        <v-card rounded="lg">
            <v-toolbar density="compact" color="#107bac" hide-details>
                <v-toolbar-title>Examination Result Template in General {{ selectedRowDetails.id }}</v-toolbar-title>
    ...
    <MFGeneralExaminationDetails :open_form_dialog="open_form_dialog" @close-dialog="closeFormDialog"/>
    <deleteConfirmation :show="confirmation" @confirm="confirm" @close="closeconfirmation" />
</template>

<script setup>
import MFGeneralExaminationDetails from './sub-forms/MFGeneralExaminationDetails.vue';
...
const headers = [
    { title: 'Description', key: 'description', align: 'start', width: "80%" },
