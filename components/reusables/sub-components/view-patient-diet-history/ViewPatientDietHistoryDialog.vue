    ...
    <v-dialog :model-value="show" rounded="lg" scrollable @update:model-value="closeDialog" max-width="1120px">    
        <v-card rounded="lg">
            <v-toolbar density="compact" color="#6984ff" hide-details>
                <v-toolbar-title>Patient Diet History {{ selectedRowDetails.id }}</v-toolbar-title>
...
const headers = [
    ...
    { title: "Nurse Station",  align: "start", sortable: false, key: "nurse_station", },
    { title: "Room No.",  align: "start", sortable: false, key: "room_no", },
    { title: "Date Served",  align: "start", sortable: false, key: "date_served", },
    { title: "Meal Type",  align: "start", sortable: false, key: "meal_type", },
