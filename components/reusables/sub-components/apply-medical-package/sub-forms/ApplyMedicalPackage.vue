<template>
    <v-dialog :model-value="open_medical_package_type" rounded="lg" scrollable @update:model-value="closeDialog" max-width="800px">
...
const headers = [
    ...
    { title: "Package Description", key: "package_description", align: "start", sortable: false, width: "50%" },
    { title: "Package Price", key: "package_price", align: "start", sortable: false, width: "20%" },
];
