        ...
        <form @submit.prevent="onSubmit">
            <v-card>
                <v-toolbar density="compact" color="#107bac" hide-details>
                    <v-toolbar-title>Post Diagnostics Medical Package {{ selectedRowDetails.id }}</v-toolbar-title>
                    ...
                    <v-row>
                        <v-col cols="12">
                            <v-card elevation="4">
                                <v-toolbar density="compact" color="#2a73c5" hide-details> 
                                    <v-toolbar-title class="toolbar-title">Diagnostic Medical Package List</v-toolbar-title>
                                </v-toolbar>
                                <v-card-text>
                                    <v-row>
                                        <v-col cols="12">
                        ...
                        <v-col cols="12">
                            <v-card elevation="4" v-if="subpanel != ''">
                                <v-toolbar density="compact" color="#2a73c5" hide-details> 
                                    <v-toolbar-title class="toolbar-title">Diagnostic Medical Package Line Items</v-toolbar-title>
                                </v-toolbar>
                                <v-card-text>
                                    <v-row>
                                        <v-col cols="12">
...
const diagnostic_medical_package = ref([
    {
        id: 1,
        code: "DMP001",
        description: "Diagnostic Medical Package 1",
        amount: 1000.00,
        expansion_items: [
            {
                id: 1,
    ...
    },
    {
        id: 2,
        code: "DMP002",
        description: "Diagnostic Medical Package 2",
        amount: 2000.00,
        expansion_items: [
            {
                id: 1,
...
const onSubmit = () => {
    alert('Post Diagnostic Medical Package Submitted');
    emits('close-dialog');
    subpanel.value = [];
}
