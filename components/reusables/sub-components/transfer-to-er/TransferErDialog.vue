        ...
        <form @submit.prevent="onSubmit">        
            <v-card rounded="lg">
                <v-toolbar density="compact" color="#107bac" hide-details>
                    <v-toolbar-title>Transfer to ER {{ selectedRowDetails.id }}</v-toolbar-title>
                ...
                <v-card-text>
                    <v-card elevation="4">
                        <v-card-text>
                            <p>
                                <span style="font-weight: bold; font-style: italic;" >NOTE: </span>Please double check the information of the registry you are about to transfer. Make sure the patient is 
                                correct there is no no way to revert this process once done. Press save to continue.
                            </p>
                        </v-card-text>
                    </v-card>
                    <v-row class="mt-2">
