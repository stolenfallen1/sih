        ...
        <form @submit.prevent="onSubmit">
            <v-card rounded="lg">
                <v-toolbar density="compact" color="#107bac" hide-details>
                    <v-toolbar-title>Manufacturers Barcode {{ selectedRowDetails.id }}</v-toolbar-title>
                ...
                <v-card-text>
                    ...
                    <v-card>
                        <v-toolbar density="compact" hide-details>
                            <v-toolbar-title class="toolbar-title">List of Manufacturer Barcode ID</v-toolbar-title>
                        </v-toolbar>
                        <v-card-text>
                            <v-data-table-server 
                        ...
                        <v-divider></v-divider>
                        <v-card-actions>
                            <v-btn class="bg-info text-white" @click="">Add Generated Barcode ID</v-btn>
                        </v-card-actions>
                    </v-card>
                </v-card-text>
                <v-divider></v-divider>
...
const headers = [
    ...
    { title: 'Manufacturer', key: 'manufacturer', align: 'start' },
    { title: 'Standard Barcode ID', key: 'standard_barcode_id', align: 'start' },
    { title: 'Custom Barcode ID', key: 'custom_barcode_id', align: 'start' },
    { title: '', key: 'actions', align: 'start' },
    { title: '', key: 'is_print', align: 'start' },
    { title: '', key: 'is_primary', align: 'start' },
];
const data = ref({
