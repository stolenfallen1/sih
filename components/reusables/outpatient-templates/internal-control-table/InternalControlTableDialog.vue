  ...
  <v-dialog :model-value="show" rounded="lg" persistent scrollable max-width="700px">
      ...
      <v-card rounded="lg">
          <v-toolbar density="compact" color="#6984ff" hide-details>
              <v-toolbar-title>Internal Control Table Template</v-toolbar-title>
              <v-spacer></v-spacer>
          ...
          <v-card-actions>
              ...
              <v-spacer></v-spacer>
              <v-btn class="bg-primary text-white" @click="openFormDialog" disabled>Add</v-btn>
          </v-card-actions>
      </v-card>
  </v-dialog>
...
const headers = [
  ...
  { title: 'Document ID', key: 'document_id', align: 'start' },
  { title: 'Description', key: 'description', align: 'start', width:"60%" },
  { title: 'Latest Series No.', key: 'latest_series_no', align: 'start' },
