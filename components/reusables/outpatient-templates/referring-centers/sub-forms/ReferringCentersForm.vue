    ...
    <form @submit.prevent="handleSubmit">
      <v-card rounded="lg">
        <v-toolbar density="compact" color="#6984ff" hide-details>
          <v-toolbar-title>Referring Center Details</v-toolbar-title>
          ...
          <v-row>
            ...
            <v-col cols="12">
              <v-radio-group  hide-details density="compact">
                  <v-checkbox label="Private" value="0" hide-details density="compact"></v-checkbox>
                  <v-checkbox label="Goverment" value="1" hide-details density="compact"></v-checkbox>
              </v-radio-group>
            </v-col>
          </v-row>
        </v-card-text>
